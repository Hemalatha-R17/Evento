        ...
        <div class="content"><!--body content holder-->
                ...
                <section>
                    <div class="container">
                        <div class="col-md-4"><!--image holder with 4 grid column-->
                            <img src="images/Toast.jpg" class="img-responsive">
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Toast & Tonic</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Toast & Tonic</h1><!--location title-->
                            <p class="location"><!--location secondary content-->
                            No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051
                            </p>
                            <p class="definition"><!--content body-->
                            Sitting amongst historic sandstone, the Toast & Tonic is the epitome of elegance for a sophisticated celebration.When you dine in the 
                            Toast & Tonic, you can choose from our award winning Saké Restaurant
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        <div class="col-md-4"><!--image holder with 4 grid column-->
                            <img src="images/Hammered.webp" class="img-responsive">
                        </div>
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Hammered Pub And Grub</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE MIDDLE OF TREE</h5><!--content title-->
                                                <p>
                                                No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051
                                                </p>
                                            </div> 
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Hammered Pub And Grub</h1><!--location title-->
                            <p class="location">No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051</p><!--location secondary content-->
                            <p class="definition">
                            Hammered Pub And Grub is the adult playground.
                            ...
                            a magnificent French meal in the Pub.
                            </p>
                            <hr class="customline3"><!--css modified horizontal line--> 
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        <div class="col-md-4"><!--image holder with 4 grid column-->
                            <img src="images/Arbor.jpg" class="img-responsive">
                        </div>    
                        <div class="modal fade" id="argyle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">Arbor Brewing Company</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>FIVE BARS OVER, AT ONE VENUE </h5><!--content title-->
                                                <p>
                                                There’s no question that The Rocks is home to some of most intriguing historical stories. And
                                                our landmark venue, Arbor Brewing Company, has a unique, rich history all of its own.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Arbor Brewing Company</h1>
                            <p class="location">No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051</p>
                            <p class="definition">There’s no question that The Rocks is home to some of most intriguing historical stories.
                                And our landmark venue, Arbor Brewing Company, has a unique, rich history all of its own. The sandstone walls that house
                                Arbor Brewing Company had seen some interesting sights well before we all hit the dance floor.</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        <div class="col-md-4"><!--image holder with 4 grid column-->
                            <img src="images/Boozy.jpg" class = "img-responsive">
                        </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">The Boozy Griffin</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>THE BEST OF GRIFFIN</h5>
                                                <p>
                                                Experience Oktoberfest 365 days of the year with uber biers, parties and food at this 1000-strong The Boozy Griffin restaurant,
                                                located at No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051.
                                                </p>
                                            </div> 
                                            <div class="modaltext2 col-md-12">
                                                <p>
                                                ...
                                                over 900 people and is locatedNo.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051
                                                </p>
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">The Boozy Griffin</h1>
                            <p class="location">No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051</p>
                            <p class="definition">The uber venue is our latest venture, bringing to life a traditional
                                ...
                                The state-of-the-art venue seats over 900 people and is located No.18, Ali Asker Rd, opp. Canara Bank, Vasanth Nagar, Bengaluru, Karnataka 560051
                                </p>
                            <hr class="customline3">   
