        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "shutter/index.html">Gallery</a></li>';
                    echo '<li><a href = "team.html">About Us</a></li>';
                    echo '<li><a href = "youtube/youtube.html">Testimonals</a></li>';
                    echo '<li><a href = "contact.php">Contact Us</a></li>';
                    echo '<li><a href = "map.html">Locations</a></li>';
                    echo '<li><a href = "viewEvents.php">Events</a></li>';
                    echo '<li><a href = "viewLocations.php">Venues</a></li>';
                    echo '<li><a href = "phpcart/EdgeSketch/index.php">Services</a></li>';
