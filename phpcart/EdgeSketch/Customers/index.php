...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li><a href="shop.php?id=1"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> Choose Services</a></li>
					<li><a href="cart_items.php"> &nbsp; <span class='fa fa-cart-plus'></span> Cart Lists</a></li>
					<li><a href="orders.php"> &nbsp; <span class='glyphicon glyphicon-list-alt'></span> My Ordered Services</a></li>
					<li><a href="view_purchased.php"> &nbsp; <span class='glyphicon glyphicon-eye-open'></span> Previous Services Ordered</a></li>
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            ...
            <img src="../assets/img/f.jpg" alt="Hero Slide" style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/d.jpg" alt="..." style="width:100%;height:500px;">
        ...
        <div class="item">
            <img src="../assets/img/a.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/e.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/b.jpg" alt="..." style="width:100%;height:500px;">
		...
		<div class="item">
            <img src="../assets/img/c.jpg" alt="..." style="width:100%;height:500px;">
