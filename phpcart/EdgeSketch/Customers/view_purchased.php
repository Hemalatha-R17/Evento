...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="view_purchased.php"> &nbsp; <span class='glyphicon glyphicon-eye-open'></span> Previous Services Ordered</a></li>
        ...
        <div id="page-wrapper">
         ...
         <center><h3> <span class="glyphicon glyphicon-eye-open"></span> Previous Services Ordered</h3></center>
        </div>
	...
	else
	{
        ...
        <div class="col-xs-12">
        	<div class="alert alert-warning">
            	<span class="glyphicon glyphicon-info-sign"></span> &nbsp; No Services Found ...
            </div>
        </div>
        <?php
	}
