        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="shop.php?id=1"> &nbsp; <span class='glyphicon glyphicon-shopping-cart'></span> Choose Services</a></li>
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our Services , Choose now!</h3></center>
        </div>
...
while($query2=mysqli_fetch_array($query))
{
	...
	echo "<div class='col-sm-3'><div class='panel panel-default' style='border-color:black;'>
